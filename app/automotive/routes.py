...
def automotive_emission(test):
    valid_tests = ["r10", "tl81000-535", "tl81000-536", "cispr25-63", "cispr25-64", "cispr25-65", "7637-2-43"]
...
def automotive_immunity(test):
    valid_tests = ["11452-2", "11452-4", "11452-5", "11452-9", "7637-2-44", "tl81000-522", "tl81000-523", "tl81000-524", "tl81000-525"]
    if test in valid_tests:
